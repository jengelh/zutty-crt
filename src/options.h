...
#define SkipLn XrmoptionSkipLine
   static const std::vector <OptionDesc> optionsTable = {
      ...
      {"fg",          SepArg,   nullptr,   "#aaa",    "Foreground color"},
      ...
      {"geometry",    SepArg,   nullptr,   "80x25",   "Terminal size in chars"},
...
#undef SkipL
   ...
   static const std::vector <ResourceDesc> resourceTable = {
      ...
      {"color3",            "#aa5500",     "Palette color 3"},
      {"color4",            "#0000aa",     "Palette color 4"},
      {"color5",            "#aa00aa",     "Palette color 5"},
      {"color6",            "#00aaaa",     "Palette color 6"},
      {"color7",            "#aaaaaa",     "Palette color 7"},
      {"color8",            "#555555",     "Palette color 8"},
      {"color9",            "#ff0000",     "Palette color 9"},
      {"color10",           "#00ff00",     "Palette color 10"},
      {"color11",           "#ffff00",     "Palette color 11"},
      {"color12",           "#0000ff",     "Palette color 12"},
